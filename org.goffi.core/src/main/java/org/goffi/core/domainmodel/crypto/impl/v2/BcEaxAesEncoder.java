 ...
 * AES + EAX
 */
public class BcEaxAesEncoder extends BaseBlockCipherEncoder {

    public BcEaxAesEncoder(Key key, byte[] nonce, byte[] nonSecretPayload) {
        super(key, nonce, nonSecretPayload);
    }

    public BcEaxAesEncoder(Key key, byte[] nonce) {
        super(key, nonce);
    }

    public BcEaxAesEncoder(Key key, int nonce) {
        super(key, nonce);
    }

    public BcEaxAesEncoder(Key key) {
        super(key);
    }
