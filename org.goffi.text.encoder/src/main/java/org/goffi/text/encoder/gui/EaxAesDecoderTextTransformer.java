 ...
 *
 * File Name: EaxAesDecoderTextTransformer.java
 *
...
public class EaxAesDecoderTextTransformer extends DecoderTextTransformerBase {

    @Override
    protected DataTransformer createDataTransformer(Key key) {
        return new BcEaxAesDecoder(key);
    }
}
